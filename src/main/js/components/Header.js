  ...
  render() {
    return(
      <nav className="navbar navbar-expand-md navbar-dark bg-dark">
        ...
        <button className="navbar-toggler" type="button" data-toggle="collapse" data-target="#menubar" aria-expanded="false">
          <span className="navbar-toggler-icon"></span>
        </button>
        <div className="collapse navbar-collapse" id="navbarNav">
          <ul className="navbar-nav">
            <li className={this.state.menu === "fellowship"? "nav-item active" : "nav-item"}>
              <a className="nav-link" href="#" onClick={(e) => this.gantiMenu("fellowship", e)}>Fellowship</a>
            </li>
